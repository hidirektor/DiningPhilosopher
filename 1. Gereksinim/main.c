...
void *yemekSureciTanimlamalari(int filozofSayisi) {
    ...
    for (i = 0; i < filozofSayisi-1; i++) {  // Ödevin 1. gereksinimi için istenen n-1 koşulunu sağlayacak döngüyü başlatıyorum.
...
int main(argc, argv) int argc; char **argv; {
    ...
    for (i = 0; i < filozofSayisi-1; i++) { // 1. gereksinimden ötürü n-1 kadar döngü başlatıyorum.
